...
class GoProController:
    ...
    def __init__(self, device_name = "wlan0", log_file = "controller.log", log_level = logging.INFO, log_format = '%(levelname)-7s %(asctime)s   %(message)s'):
        # setup log
    ...
    def test(self):
        print self.getStatus("SARSGoPro", "sarsgopro")
